public static class Messages{
    ...
    public static string TITULO_TELA_FASES = "Fase {0}";
    public static string TITULO_BOARD_COMANDOS= "Peças usadas";
    ...
    public static string BOTAO_PROXIMA_FASE = "Próxima fase";
    public static string BOTAO_OK = "OK";
    public static string BOTAO_SIM = "Sim";
    public static string BOTAO_NAO_TENTAR_NOVAMENTE = "Não, tentar novamente";
